  ...
  return (
    <>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <div className="relative bg-[#fafafa] w-full max-w-xl shadow-2xl overflow-hidden">
          {/* Header */}
          <div className="bg-[#fafafa] border-b border-foreground/15 px-10 py-6 flex items-center justify-between">
